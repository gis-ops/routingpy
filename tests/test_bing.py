...
from routingpy import Bing
from routingpy.direction import Direction
from tests.test_helper import *

class BingTest(_test.TestCase):
    name = "bing"

    def setUp(self):
        self.key = "sample_key"
        self.client = Bing(api_key=self.key)
    ...
    def test_directions(self):
        ...
        self.assertURLEqual(
            "http://dev.virtualearth.net/REST/V1/Routes/Driving?key=sample_key&wp.0=8.688641%2C49.420577&wp.1=8.680916%2C49.415776",

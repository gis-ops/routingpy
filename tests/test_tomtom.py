...
from routingpy import TomTom
from routingpy.direction import Direction
from tests.test_helper import *

class TomTomTest(_test.TestCase):
    name = "tomtom"

    def setUp(self):
        self.key = "sample_key"
        self.client = TomTom(api_key=self.key)
    ...
    def test_directions(self):
        ...
        self.assertURLEqual(
            "https://api.tomtom.com/routing/1/calculateRoute/8.688641%2C49.420577%3A8.680916%2C49.4157767json?key=sample_key",
